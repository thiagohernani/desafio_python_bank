...
def filtrar_usuario(cpf, usuarios):
    usurios_filtrados = [usuario for usuario in usuarios if usuario["cpf"] == cpf ]
    return usurios_filtrados[0] if usurios_filtrados else None
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            numero_conta = len(contas) + 1 # para criar uma opção de deletar conta remover essa váriavel
